...
export const me7741ScenarioSignals: ScenarioSignal[] = [
  {
    ...
    summary: "Emergency intake pressure rising at hospital-east-04",
    emitAtTick: 0,
  ...
  },
  {
    ...
    severity: "warning",
    kind: "incident.signal",
    summary: "P2 wait times above threshold",
    emitAtTick: 0,
    visibility: { operator: true, auroraContext: true, workspace: true },
    relatedEntityIds: ["ME-7741"],
  },
  ...
  },
  {
    ...
    severity: "warning",
    kind: "incident.signal",
    summary: "Automated routing validation unavailable",
    emitAtTick: 0,
    visibility: { operator: true, auroraContext: true, workspace: true },
    relatedEntityIds: ["ME-7741"],
  },
